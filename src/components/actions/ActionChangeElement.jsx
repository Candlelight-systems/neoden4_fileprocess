	...
	return (
		<div>
				...
				<div className="form-element">
					...
					<div className="col-sm-8">
						<select className="form-control"  onChange={  ( e ) => changeColumnName( e, actionId ) } value={ columnName }>
							<option>Select a column</option>{ cols.map( col => <option value={ col.name }>{ col.value }</option> ) }
						</select>
					</div>
				</div>
				<div className="form-element">
					...
					<div className="col-sm-8">
						<input className="form-control" type="text" onChange={  ( e ) => changeColumnValue( e, actionId ) } value={ columnValue } />
					</div>
				</div>
		</div>
